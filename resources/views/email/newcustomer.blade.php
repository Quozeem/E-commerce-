        ...
        <div class="grid__item footer_copyright">
            <div class="wrapper">
                <div class="grid">
                    ...
                    </div><div style="margin-right:0%;margin-left:80%">
                    <a href="https://www.facebook.com/qoztore" style="color: #949697;
    background: darkred;font-size:25px"><i class="fab fa-facebook-f"></i></a>
                                     <a style="color: #949697;
    background: darkred;font-size:25px" href="https://www.twitter.com/Qoztore"><i class="fab fa-twitter"></i></a>
                                    <a style="color: #949697;
    background: darkred;font-size:25px" href="https://www.instagram.com/qoztore/"><i class="fab fa-instagram"></i></a>
                </div>  </div>
            </div>
        </div>
