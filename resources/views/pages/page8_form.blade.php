									        ...
									        <div class="col-lg-3" style="width:50%;">
												...
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="">
															<img src="img/bg/Nike mercurial 35000.jpeg"  alt="Demo Product Sample">
														</a>
														<div class="quickview">
													...
													<p class="h6 product-title">
														<a href="">Nike mercurial</a>
													</p>
													<p class="product-price" style="margin-top:-5%">
													
														<span class="money" data-currency-usd="$19.99">#35,000</span>
											 ...
											 <div class="col-lg-3" style="width:50%;">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="">
															<img src="img/bg/Adidas joggers 12000.jpeg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
													...
													<p class="h6 product-title">
														<a href="" style="width:100%">Adidas joggers</a>
													</p>
													<p class="product-price" style="margin-top:-5%">
											 ...
											 <div class="col-lg-3" style="width:50%">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="">
															<img src="img/bg/Nike kit bag 9000.jpeg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
													...
													<p class="h6 product-title">
														<a href="">Nike kit bag</a>
													</p>
													<p class="product-price" style="margin-top:-5%">
														<strong>On Sale</strong>
														<span class="money" data-currency-usd="$19.99">#9,000</span>
												...
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="">
															<img src="img/bg/Nike joggers12000.jpeg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
											...
											<div class="grid__item large--one-quarter medium--one-half">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														...
														<img src="img/bg/Adidas nemesis 30 000.jpeg" alt="Consequuntur magni dolores">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
													...
													<p class="h6 product-title">
														<a href="">Adidas nemesis</a>
													</p>
													<p class="product-price">
														<strong>On Sale</strong>
														<span class="money" data-currency-usd="$19.99">#30,000</span>
															<span class="visually-hidden">Regular price</span>
														<s><span class="money" data-currency-usd="$24.99">$64.00</span></s>
										...
										<div class="element full_width" data-animate="fadeInUp" data-delay="100">
											<div class="grid__item large--one-quarter medium--one-half">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="" class="grid__image product-image">
														<img src="img/bg/wears.jpeg" alt="Corporis suscipit laboriosam">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
													...
													<p class="product-price">
														<span class="money" data-currency-usd="$89.00">#15,000</span>
															<span class="visually-hidden">Regular price</span>
														<s><span class="money" data-currency-usd="$24.99">$32.00</span></s>
													</p>
