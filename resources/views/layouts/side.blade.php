...
<script data-ad-client="ca-pub-1524909513204551" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
...
<!--<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"></script---->
        <link rel="stylesheet" href="{{ asset('css/bootstrap.min.css')}}">   <link rel="stylesheet" href="css/animate.min.css">
	...
	<link href="{{ asset('assets/css/home_market.style.scss.css')}}" rel="stylesheet" type="text/css" media="all">
...
@if(session('cartsucces'))
						<script type="text/javascript">
window.setTimeout("document.getElementById('displaytime').style.display='none';",3500);</script>
					<div id="displaytime" class="alert alert-success" style="text-align:center";>
					{{ session("cartsucces")}}</div>
				@endif
			<div class="wrapper">
		...
		<input type="search" name="search" id="search" class="input-group-field st-default-search-input" placeholder="Search our store" aria-label="Search our store">
	...
	$('#search').on('change', function() {
	  ...
	  // let search=$('input[name="search"]').val();
		$.ajax({
            type:"GET",
            url:'livesearch/'+getStId,
         
           success:function(response) {
           console.log(response);
        //  $("#textField").html(response);
           }
          });
								});
													});
		...
		<a href="cart" class="jss-drawer-open-right site-nav__link">
								 ...
								 <span id="CartCount"> 	@if((session('cart')))
						{{count((session('cart')))}}
						@else
						{{'0'}}
						@endif </span>
							...
							<li class="header-account">
								...
								<div id="loginBox" class="loginLightbox" style="display:none;">
									<div id="lightboxlogin">
										<form method="post" action="{{route('logincustomer')}}" id="customer_login" accept-charset="UTF-8">
									@csrf		<input type="hidden" value="customer_login" name="form_type"><input type="hidden" name="utf8" value="âœ“">
											<div id="bodyBox">
												<h3>Login</h3>
                                        ...
                                        @endif
												...
												<input type="password"  name="password"
												 ...
												 <div class="eyes">
<i class="fa fa-eye" aria-hidden="true" onclick="myFunctioned()"></i></div>
					...
					<div  class="alert alert-warning">    
									...
									@endif
										<div class="form-vertical">
											<form method="post" action="{{ url('customers')}}" name="myForm" enctype="multipart/form-data" onsubmit="return validateForm()" id="create_customer" accept-charset="UTF-8">
											{{ csrf_field() }}
