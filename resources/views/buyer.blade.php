									...
									@csrf	<input type="hidden" value="customer_login" name="form_type"><input type="hidden" name="utf8" value="✓">
										<h3>Login</h3>
                                          @if(Session::has('errorMessage'))
											 ...
											 @elseif(Session::has('Chat'))
                                              <div class="alert alert-success" style="color:red;font-weight:600">
                                             {{ Session::get('Chat' )}} </div>
                                        @endif	
...
@error('password')
                                ...
                                @enderror	
								<input type="hidden" name="unique_id" value="<?php echo(rand(00000,99999));?>" required="">	
							<input type="checkbox"  value="0" required=""> I accept the Terms of Use & Privacy Policy.	
												<p>
