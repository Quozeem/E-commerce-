...
<?php $__env->startSection('content'); ?>
      ...
      <div class="card mb-3">
            ...
            <p class="mb-0 mt-2"><?php echo e(session('address')); ?></p>
           <p class="mb-0 mt-2"><?php echo e(session('lga')); ?> <?php echo e(session('state')); ?>,<?php echo e(session('country')); ?>.</p><h5 style="color: #ff6a00;">Order Number :<?php echo e(session('orderNumber')); ?></h5>
            </div>
          </div>
...
<form name="form1" class="row g-3" onsubmit="return validate()" method="post" action="<?php echo e(route('orderitem')); ?>">
             <?php echo csrf_field(); ?>
                    <div class="col-md-4"><label class="form-label">Full name</label>
                        <input class="form-control"  type="text" name="name" 
                        value="<?php if(Auth::guard('customer')->user() != null): ?> <?php echo e(Auth::guard('customer')->user()->fname); ?> <?php else: ?> <?php echo e(session('name')); ?> <?php endif; ?>" required="" />
                      <div class="valid-feedback">Looks good!</div>
                    </div>
        
                    <div class="col-md-4"><label class="form-label">Phone</label>
                    <input class="form-control"  type="tel" name="phone" value="<?php if((session('phone'))): ?> <?php echo e(session('phone')); ?><?php endif; ?>" required="" />
                      <div class="valid-feedback">Looks good!</div>
                    </div>
                    <div class="col-md-4"><label class="form-label">Email</label>
                      <div class="input-group has-validation"><span class="input-group-text" id="inputGroupPrepend">@</span>
                      <input class="form-control"  name="email" 
                      value=" <?php if(Auth::guard('customer')->user() != null): ?><?php echo e(Auth::guard('customer')->user()->email); ?> <?php else: ?> <?php echo e(session('email')); ?> <?php endif; ?>" type="text" aria-describedby="inputGroupPrepend" required="" />
                        <div class="invalid-feedback">Please choose a username.</div>
                      </div>
                    </div>
                    <div class="col-md-6"><label class="form-label">Address</label>
                    <input class="form-control"  type="text" name="address" value="<?php if((session('address'))): ?> <?php echo e(session('address')); ?><?php endif; ?>" required="" />
  ...
  <?php $__currentLoopData = (session('cart')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$product_details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   ...
                   <option value="">- Select -</option>
                    <?php $__currentLoopData = $shipping; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    <option value= "<?php echo e($state_name->states_name); ?>"><?php echo e($state_name->states_name); ?> State</option>
                  ...
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                    </select>
                      ...
                      <?php if((session('lga'))): ?>  <option><?php echo e(session('lga')); ?></option>
                       <?php endif; ?>
                                    </select>
                                    </div>
                                     <div class="col-md-4">
                      ...
                      <select class="form-control select-lga" name="name_city" id="name_city"
                       disable="disable">
                       <?php if((session('shipping'))): ?>  <option>#<?php echo e(session('shipping')); ?></option>
                       <?php else: ?>
                       <option>Pick State first*</option><?php endif; ?></select>
           ...
           <div class="card mb-3">
            ...
            <div class="card-header">
             ...
             <?php if(((session('cart')) == null)): ?><button disabled="disabled" class="btn btn-sm active" style="padding:2%;font-size:17px;width: 100%;background-color:#ff6a00;border-color: #ff6a00"> 
               <a  style="color:white" href="orderdetails"><i class="fas fa-shopping-cart" aria-hidden="true">
               </i>
               Checkout</a></button> 
               <?php elseif(((session('address')) == null)): ?><button disabled="disabled" class="btn btn-sm active" style="padding:2%;font-size:17px;width: 100%;background-color:#ff6a00;border-color: #ff6a00"> 
               <a  style="color:white" href="orderdetails"><i class="fas fa-shopping-cart" aria-hidden="true">
               </i>
               Checkout</a></button> 
               <?php else: ?><button class="btn btn-sm active" style="padding:2%;font-size:17px;width: 100%;background-color:#ff6a00;border-color: #ff6a00"> 
               <a  style="color:white" href="orderdetails"><i class="fas fa-shopping-cart" aria-hidden="true">
            </i>   Checkout</a></button> <?php endif; ?>
               </div>      
                </div>
                <div class="col-auto ms-auto">
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="<?php echo e(asset ('assets/js/shipping.js')); ?>"></script>
...
<?php echo $__env->make('layouts.addressbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Documents\laravel\shopify\resources\views/checkout/billingaddress.blade.php ENDPATH**/ ?>