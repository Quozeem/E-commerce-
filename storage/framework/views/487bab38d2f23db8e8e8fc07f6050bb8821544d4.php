...
<?php $__env->startSection('content'); ?>
 ...
 <?php $total = 0;  ?>
  <?php $__currentLoopData = (session('cart')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$orderdetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <?php $total +=$orderdetails['price'] * $orderdetails['quantity'] ?>
                      <th class="ps-0 pt-0"><?php echo e($orderdetails['brand']); ?><div class="text-400 fw-normal fs--2">QTY <?php echo e($orderdetails['quantity']); ?> / Size
                    ...
                    <div class="col-md-6 mb-3 mb-md-0">
                      <div class="form-check mb-0 custom-radio radio-select"><input class="form-check-input"
					   ...
					   <label class="form-check-label mb-0 fw-bold d-block" for="address-1">Nearest Bus stop
						    <span class="radio-select-content"><span><?php echo e(session('address')); ?>

                    <span class="d-block mb-0 pt-2"><?php echo e(session('phone')); ?></span></span></span></label></div>
                    </div>
                    <div class="col-md-6">
                      <div class="position-relative">
                        <div class="form-check mb-0 custom-radio radio-select">
							...
							<label class="form-check-label mb-0 fw-bold d-block" for="address-2">State
								<span class="radio-select-content"><span><?php echo e(session('lga')); ?>

                        <br/><?php echo e(session('state')); ?>, <br/><?php echo e(session('country')); ?><span class="d-block mb-0 pt-2"></span></span></span></label></div>
                      </div>
                    </div>
                  </div>
                </div>
...
<input type="hidden" value="<?php echo e(Paystack::genTranxRef()); ?>" name="reference"><!-----required---->
...
<?php echo $__env->make('layouts.addressbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Documents\laravel\shopify\resources\views/checkout/orderdetail.blade.php ENDPATH**/ ?>