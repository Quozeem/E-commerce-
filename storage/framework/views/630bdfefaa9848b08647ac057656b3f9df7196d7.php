...
function validateForm() {
  ...
  if (file == "") {
   document.getElementById("files").innerHTML="Image is required*";
									        ...
									        <div class="col-lg-3" style="width:50%;">
												...
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="">
															<img src="img/feed production.jpeg"  alt="Demo Product Sample">
														</a>
														<div class="quickview">
													...
													<p class="h6 product-title">
														<a href="">feed production</a>
													</p>
													<p class="product-price" style="margin-top:-5%">
													
														<!--<span class="money" data-currency-usd="$19.99">#3,400</span--->
												<s><span class="money" data-currency-usd="$24.99">$180.22</span></s>
													</p>
											 ...
											 <div class="col-lg-3" style="width:50%;">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="">
															<img src="img/corn stack pellet.jpeg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
													...
													<p class="h6 product-title">
														<a href="" style="width:100%">Cattle feed pellets</a>
													</p>
													<p class="product-price" style="margin-top:-5%">
												
														<!--<span class="money" data-currency-usd="$19.99">#2,500</span-->
															<span class="visually-hidden">Regular price</span>
														<s><span class="money" data-currency-usd="$24.99">$160.77</span></s>
											 ...
											 <div class="col-lg-3" style="width:50%">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="">
															<img src="img/fresh crate of eggs.jpeg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
													...
													<p class="h6 product-title">
														<a href="">fresh crate of eggs</a>
													</p>
													<p class="product-price" style="margin-top:-5%">
														<strong>On Sale</strong>
													<!----	<span class="money" data-currency-usd="$19.99">#2,400</span--->
														<span class="visually-hidden">Regular price</span>
														<s><span class="money" data-currency-usd="$24.99">$60.77</span></s>
													</p>
												...
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="">
															<img src="img/poultry and livestocktu.jpeg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
													...
													<p class="h6 product-title">
														<a href="">poultry and livestock</a>
													</p>
													<p class="product-price" style="margin-top:-5%">
														<strong>On Sale</strong>
													<!---	<span class="money" data-currency-usd="$19.99">#3,500</span--->
															<span class="visually-hidden">Regular price</span>
														<s><span class="money" data-currency-usd="$24.99">$200.77</span></s>
													</p>
						...
						<div class="group_sidebar">
							<div class="sb-wrapper featured-product-wrapper clearfix" data-animate="" data-delay="0">
								<div class="featured-product">
									<h6 class="sb-title">Weekly deals</h6>
											...
											<div class="grid__item large--one-quarter medium--one-half">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														...
														<img src="img/pellets.jpeg" alt="Consequuntur magni dolores">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
													...
													<p class="product-price">
														<strong>On Sale</strong>
														<!---<span class="money" data-currency-usd="$19.99">#34,940</span--->
															<span class="visually-hidden">Regular price</span>
														<s><span class="money" data-currency-usd="$24.99">$22.22</span></s>
										...
										<div class="element full_width" data-animate="fadeInUp" data-delay="100">
											<div class="grid__item large--one-quarter medium--one-half">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="" class="grid__image product-image">
														<img src="img/poultry.jpeg" alt="Corporis suscipit laboriosam">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
													...
													<p class="product-price">
													<!---	<span class="money" data-currency-usd="$89.00">#5,000</span--->
															<span class="visually-hidden">Regular price</span>
														<s><span class="money" data-currency-usd="$24.99">$6.77</span></s>
													</p>
    ...
    flex-direction:wrap;">
						 <div class="col-lg-2" style="width:33.33%;margin-bottom:3%;padding-left:3px;padding-right:3px">
                         <?php $__currentLoopData = $Agriculture; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<div style="">
											<div>
...
</body><?php /**PATH C:\Users\DELL\Documents\laravel\shopify\resources\views/page7_form.blade.php ENDPATH**/ ?>