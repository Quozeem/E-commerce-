...
function validateForm() {
  ...
  if (file == "") {
   document.getElementById("files").innerHTML="Image is required*";
									        ...
									        <div class="col-lg-3" style="width:50%;">
												...
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="">
															<img src="assets/images/Hublot80001.jpeg"  alt="Demo Product Sample">
														</a>
														<div class="quickview">
													...
													<p class="product-price" style="margin-top:-5%">
														...
														<span class="money" data-currency-usd="$19.99">#8,000</span>
											 ...
											 <div class="col-lg-3" style="width:50%;">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="">
															<img src="assets/images/Roundneck8000.jpeg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
													...
													<p class="h6 product-title">
														<a href="" style="width:100%">Roundneck</a>
													</p>
													<p class="product-price" style="margin-top:-5%">
											 ...
											 <div class="col-lg-3" style="width:50%">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="">
															<img src="assets/images/slides1.jpeg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
													...
													<p class="product-price" style="margin-top:-5%">
														...
														<span class="money" data-currency-usd="$19.99">#7,000</span>
												...
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="">
															<img src="assets/images/bags11000.jpeg" alt="Demo Product Sample">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
													...
													<p class="product-price" style="margin-top:-5%">
														<strong>On Sale</strong>
														<span class="money" data-currency-usd="$19.99">#11,000</span>
						...
						<div class="group_sidebar">
							<div class="sb-wrapper featured-product-wrapper clearfix" data-animate="" data-delay="0">
								<div class="featured-product">
									<h6 class="sb-title">New Offer</h6>
											...
											<div class="grid__item large--one-quarter medium--one-half">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														...
														<img src="assets/images/Hublot10000.jpeg" alt="Consequuntur magni dolores">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
																<div data-handle="consequuntur-magni-dolores" class="quick_shop-div">
													...
													<p class="product-price">
														<strong>On Sale</strong>
														<span class="money" data-currency-usd="$19.99">#10,000</span>
										...
										<div class="element full_width" data-animate="fadeInUp" data-delay="100">
											<div class="grid__item large--one-quarter medium--one-half">
												<div class="grid__item_wrapper">
													<div class="grid__image product-image">
														<a href="" class="grid__image product-image">
														<img src="assets/images/bag3000.jpeg" alt="Corporis suscipit laboriosam">
														</a>
														<div class="quickview">
															<div class="product-ajax-cart hidden-xs hidden-sm">
													...
													<p class="product-price">
														<span class="money" data-currency-usd="$89.00">#3,000</span>
															<span class="visually-hidden">Regular price</span>
    ...
    flex-direction:wrap;">
						 <div class="col-lg-2" style="width:33.33%;margin-bottom:3%;padding-left:3px;padding-right:3px">
                         <?php $__currentLoopData = $fashion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<div style="">
											<div>
...
</body><?php /**PATH C:\Users\DELL\Documents\laravel\shopify\resources\views/pages/page4_form.blade.php ENDPATH**/ ?>