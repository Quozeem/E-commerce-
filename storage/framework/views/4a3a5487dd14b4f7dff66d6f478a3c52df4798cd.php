						...
						<div class="grid">
							<div class="grid__item large--one-third push--large--one-third text-center">
								...
								<div id="CustomerLoginForm" class="form-vertical">
									<form method="post" action="<?php echo e(route('loginreview')); ?>" id="" name="myForm" onsubmit="return validateForm()" accept-charset="UTF-8">
									<?php echo csrf_field(); ?>	<input type="hidden" value="customer_login" name="form_type"><input type="hidden" name="utf8" value="✓">
										<h3>Login</h3>
...
<div id="create_accountBoxd" style="display:none;">
										<h3>Create Account</h3>
										<div class="form-vertical">
							<form method="post" action="<?php echo e(url('customers')); ?>" name="myForm" enctype="multipart/form-data" accept-charset="UTF-8">
...
<?php echo $__env->make('layouts.loginbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Documents\laravel\shopify\resources\views/reviewlogin.blade.php ENDPATH**/ ?>